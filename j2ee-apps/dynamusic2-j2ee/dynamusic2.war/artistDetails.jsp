                ...
                <tr>
                    ...
                    <td width="100" bgcolor="ghostwhite" valign="top">
                        ...
                        <font face="Verdana,Geneva,Arial" size="-1" color="steelblue">
                            <dsp:a href="newAlbum.jsp"><dsp:param name="artistId" param="element.id"/><b>Add
                                Album</b></dsp:a>
                            <br>
                            <dsp:a href="editArtist.jsp"><dsp:param name="artistId" param="element.id"/><b>Edit Artist
                                Info</b></dsp:a>
                        </font>
                    </td>
