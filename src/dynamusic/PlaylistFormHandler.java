...
public class PlaylistFormHandler extends RepositoryFormHandler {
    ...
    public void setPlaylistManager(PlaylistManager pPM) {
        mPM = pPM;
    }
    ...
    public String getAddSongSuccessURL() {
        return mAddSongSuccessURL;
    }

    public void setAddSongSuccessURL(String pAddSongSuccessURL) {
        mAddSongSuccessURL = pAddSongSuccessURL;
    }

    public String getAddSongErrorURL() {
        return mAddSongErrorURL;
    }

    public void setAddSongErrorURL(String pAddSongErrorURL) {
        mAddSongErrorURL = pAddSongErrorURL;
    }
